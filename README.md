...
### 4.Train/Test
Run the train script on synapse dataset. The batch size can be reduced to 12 or 16(Set size is 24) to save memory(please also decrease the base_lr linearly), and both can reach similar performance.
